...
object RegularExpressions {
    /**
     * A newline including horizontal whitespace that follows, allowing us to get the indentation
     * level from the matched content.
     */
    val NEWLINE = Regex("""\n[ \t]*""")
     ...
     *
     * Additional forms of character escapes can be recognized (or rejected) in post-processing.
     */
    ...
    /**
     * Recognizes double-quoted strings using doubled double-quotes as escape for double-quotes,
     * as used in the CSV format and BASIC interpreters.
     */
